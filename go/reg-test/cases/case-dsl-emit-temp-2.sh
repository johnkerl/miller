...
announce "3. NON-LASHED INDEXED MAP UNDER"
run_mlr --ojson --jvstack --from $indir/abixy put -q '
  @sumx += $x;
  @countx += 1;
  @sums[$a][$b] += $x;
...
announce "3. NON-LASHED INDEXED MAP AT"
run_mlr --ojson --jvstack --from $indir/abixy put -q '
  @sumx += $x;
  @countx += 1;
  @sums[$a][$b] += $x;
...
announce "3. NON-LASHED INDEXED MAP OVER"
run_mlr --ojson --jvstack --from $indir/abixy put -q '
  @sumx += $x;
  @countx += 1;
  @sums[$a][$b] += $x;
...
announce "4. LASHED INDEXED MAP UNDER"
run_mlr --ojson --jvstack --from $indir/abixy put -q '
  @sumx += $x;
  @countx += 1;
  @sums[$a][$b] += $x;
...
announce "4. LASHED INDEXED MAP AT"
run_mlr --ojson --jvstack --from $indir/abixy put -q '
  @sumx += $x;
  @countx += 1;
  @sums[$a][$b] += $x;
...
announce "4. LASHED INDEXED MAP OVER"
run_mlr --ojson --jvstack --from $indir/abixy put -q '
  @sumx += $x;
  @countx += 1;
  @sums[$a][$b] += $x;
