...
var TokMap = TokenMap{
	...
	idMap: map[string]Type{
		...
		"(":                           75,
		")":                           76,
		"md_token_string_literal":     77,
		"md_token_int_literal":        78,
		"md_token_float_literal":      79,
		"md_token_boolean_literal":    80,
		"md_token_M_PI":               81,
		"md_token_M_E":                82,
		"md_token_panic":              83,
		"[":                           84,
		...
		"md_token_NR":                 93,
		"md_token_FNR":                94,
		"md_token_FILENAME":           95,
		"md_token_FILENUM":            96,
		"md_token_int_type":           97,
		"md_token_float_type":         98,
		"md_token_begin":              99,
		"md_token_end":                100,
		"md_token_if":                 101,
		"md_token_elif":               102,
