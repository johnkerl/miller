...
var TokMap = TokenMap{
	...
	idMap: map[string]Type{
		...
		"(":                           70,
		")":                           71,
		"md_token_string_literal":     72,
		"md_token_int_literal":        73,
		"md_token_float_literal":      74,
		"md_token_boolean_literal":    75,
		"md_token_M_PI":               76,
		"md_token_M_E":                77,
		"md_token_panic":              78,
		",":                           79,
		...
		"md_token_NR":                 87,
		"md_token_FNR":                88,
		"md_token_FILENAME":           89,
		"md_token_FILENUM":            90,
		"md_token_non_sigil_name":     91,
		"md_token_int_type":           92,
		"md_token_float_type":         93,
	},
}
