...
var TokMap = TokenMap{
	...
	idMap: map[string]Type{
		...
		"(":                           83,
		")":                           84,
		"md_token_string_literal":     85,
		"md_token_int_literal":        86,
		"md_token_float_literal":      87,
		"md_token_boolean_literal":    88,
		"md_token_M_PI":               89,
		"md_token_M_E":                90,
		"md_token_panic":              91,
		"[":                           92,
		...
		"md_token_NR":                 101,
		"md_token_FNR":                102,
		"md_token_FILENAME":           103,
		"md_token_FILENUM":            104,
		"md_token_begin":              105,
		"md_token_end":                106,
		"md_token_if":                 107,
		"md_token_elif":               108,
