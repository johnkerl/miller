...
var TokMap = TokenMap{
	...
	idMap: map[string]Type{
		...
		"$[":                          16,
		"md_token_braced_field_name":  17,
		"md_token_full_srec":          18,
		"md_token_oosvar_name":        19,
		"@[":                          20,
		"md_token_braced_oosvar_name": 21,
		"md_token_full_oosvar":        22,
		"||=":                         23,
		"^^=":                         24,
		"&&=":                         25,
		"|=":                          26,
		...
		"(":                           73,
		")":                           74,
		"md_token_string_literal":     75,
		"md_token_int_literal":        76,
		"md_token_float_literal":      77,
		"md_token_boolean_literal":    78,
		"md_token_M_PI":               79,
		"md_token_M_E":                80,
		"md_token_panic":              81,
		",":                           82,
		...
		"md_token_NR":                 90,
		"md_token_FNR":                91,
		"md_token_FILENAME":           92,
		"md_token_FILENUM":            93,
		"md_token_non_sigil_name":     94,
		"md_token_int_type":           95,
		"md_token_float_type":         96,
	},
}
