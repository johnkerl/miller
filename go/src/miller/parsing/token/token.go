...
var TokMap = TokenMap{
	...
	idMap: map[string]Type{
		...
		"md_token_dump":               7,
		"md_token_edump":              8,
		"md_token_field_name":         9,
		"$[":                          10,
		"]":                           11,
		"md_token_braced_field_name":  12,
		"md_token_full_srec":          13,
		"md_token_oosvar_name":        14,
		"@[":                          15,
		"md_token_braced_oosvar_name": 16,
		"md_token_full_oosvar":        17,
		"||=":                         18,
		"^^=":                         19,
		"&&=":                         20,
		"|=":                          21,
		...
		"(":                           68,
		")":                           69,
		"md_token_string_literal":     70,
		"md_token_int_literal":        71,
		"md_token_float_literal":      72,
		"md_token_boolean_literal":    73,
		"md_token_M_PI":               74,
		"md_token_M_E":                75,
		"md_token_panic":              76,
		"[":                           77,
		...
		"md_token_NR":                 88,
		"md_token_FNR":                89,
		"md_token_FILENAME":           90,
		"md_token_FILENUM":            91,
		"md_token_non_sigil_name":     92,
