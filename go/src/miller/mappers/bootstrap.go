...
// ----------------------------------------------------------------
var BootstrapSetup = mapping.MapperSetup{
	Verb:         "bootstrap",
...
func mapperBootstrapParseCLI(
	...
	mapper, _ := NewMapperBootstrap(*pNout)
...
func NewMapperBootstrap(nout int) (*MapperBootstrap, error) {
...
func (this *MapperBootstrap) Map(
	...
	if inrecAndContext.Record != nil {
		...
		//
		// For that reason, this mapper must copy all output.
