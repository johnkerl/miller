...
func init() {
	...
	_ = ss.Set('1', appender1)
	_ = ss.Set('2', appender2)
	_ = ss.Set('3', appender3)
	_ = ss.Set('4', appender4)
	_ = ss.Set('5', appender5)
	_ = ss.Set('6', appender6)
	_ = ss.Set('7', appender7)
	_ = ss.Set('8', appender8)
	_ = ss.Set('9', appender9)
	_ = ss.Set('N', appenderN)
	_ = ss.Set('O', appenderO)
