...
* [./scripts/prep-perf-data.sh](./scripts/prep-perf-data.sh) -- Create million-record data files in various formats.
* [./scripts/time-verbs.py](./scripts/time-verbs.py) -- Run a few processing scenarios on the million-record CSV file.
  ...
  * A third batch of cases runs longer and longer chains of `scripts/chain1.mlr`, showing how Miller handles multicore and concurrency.
