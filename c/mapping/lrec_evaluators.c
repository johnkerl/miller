...
mv_t lrec_evaluator_b_b_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
	lrec_evaluator_b_b_state_t* pstate = pvstate;
	mv_t val1 = pstate->parg1->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pstate->parg1->pvstate);
...
mv_t lrec_evaluator_b_bb_and_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
	...
	mv_t val2 = pstate->parg2->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pstate->parg2->pvstate);
...
mv_t lrec_evaluator_b_bb_or_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_b_bb_xor_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_z_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_f_f_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_n_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_i_i_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_f_ff_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_n_nn_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_n_nn_nullable_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_f_fff_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
	...
	mv_t val3 = pstate->parg3->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pstate->parg3->pvstate);
...
mv_t lrec_evaluator_i_ii_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_i_iii_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_ternop_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
	...
	return val1.u.boolv
		? pstate->parg2->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pstate->parg2->pvstate)
		: pstate->parg3->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pstate->parg3->pvstate);
}
...
mv_t lrec_evaluator_s_s_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_s_f_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_s_i_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_f_s_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_i_s_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_x_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_b_xx_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_ns_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_ss_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_ssc_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_sr_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_s_xs_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_s_sss_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_x_srs_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_field_name_func_string_only(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_field_name_func_string_float(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_oosvar_name_func_string_only(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
	...
	// See comments in lrec_evaluator.h and mapper_put.c regarding the typed-overlay map.
	mv_t* poverlay = lhmsv_get(poosvars_typed_overlay, pstate->oosvar_name);
	if (poverlay != NULL) {
		// The lrec-evaluator logic will free its inputs and allocate new outputs, so we must copy
		// a value here to feed into that. Otherwise the typed-overlay map would have its contents
		// freed out from underneath it by the evaluator functions.
		...
		char* string = lrec_get(poosvars, pstate->oosvar_name);
		if (string == NULL) {
			return MV_NULL;
		} else {
			// string points into AST memory and is valid as long as the AST is.
...
mv_t lrec_evaluator_oosvar_name_func_string_float(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_oosvar_name_func_string_float_int(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures, context_t* pctx, void* pvstate)
{
	lrec_evaluator_oosvar_name_state_t* pstate = pvstate;
...
lrec_evaluator_t* lrec_evaluator_alloc_from_oosvar_name(char* oosvar_name, int type_inferencing) {
	...
	switch (type_inferencing) {
	case TYPE_INFER_STRING_ONLY:
		pevaluator->pprocess_func = lrec_evaluator_oosvar_name_func_string_only;
		break;
	case TYPE_INFER_STRING_FLOAT:
		pevaluator->pprocess_func = lrec_evaluator_oosvar_name_func_string_float;
		break;
	case TYPE_INFER_STRING_FLOAT_INT:
		pevaluator->pprocess_func = lrec_evaluator_oosvar_name_func_string_float_int;
		break;
	default:
		fprintf(stderr, "%s: internal coding error detected in file %s at line %d.\n",
			MLR_GLOBALS.argv0, __FILE__, __LINE__);
...
mv_t lrec_evaluator_non_string_literal_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_string_literal_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
mv_t lrec_evaluator_boolean_literal_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ================================================================
mv_t lrec_evaluator_NF_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ----------------------------------------------------------------
mv_t lrec_evaluator_NR_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ----------------------------------------------------------------
mv_t lrec_evaluator_FNR_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ----------------------------------------------------------------
mv_t lrec_evaluator_FILENAME_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ----------------------------------------------------------------
mv_t lrec_evaluator_FILENUM_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ----------------------------------------------------------------
mv_t lrec_evaluator_PI_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
...
// ----------------------------------------------------------------
mv_t lrec_evaluator_E_func(lrec_t* prec, lhmsv_t* ptyped_overlay,
	lrec_t* poosvars, lhmsv_t* poosvars_typed_overlay,
	string_array_t* pregex_captures,
	context_t* pctx, void* pvstate)
{
	...
	int type_inferencing, function_lookup_t* fcn_lookup_table)
{
	if (pnode->pchildren == NULL) { // leaf node
		...
		&& (pnode->type != MLR_DSL_AST_NODE_TYPE_OPERATOR)) {
			fprintf(stderr, "%s: internal coding error detected in file %s at line %d: node type 0x%04x\n",
				MLR_GLOBALS.argv0, __FILE__, __LINE__, pnode->type);
			exit(1);
		}
...
static char * test1() {
	...
	lrec_t* poosvars = lrec_unbacked_alloc();
	lhmsv_t* poosvars_typed_overlay = lhmsv_alloc();
	string_array_t* pregex_captures = NULL;

	mv_t val = pnr->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pnr->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_INT);
	mu_assert_lf(val.u.intv == 888);

	val = pfnr->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pfnr->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_INT);
	mu_assert_lf(val.u.intv == 999);

	val = pfilename->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pfilename->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_STRING);
	mu_assert_lf(val.u.strv != NULL);
	mu_assert_lf(streq(val.u.strv, "filename-goes-here"));

	val = pfilenum->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pfilenum->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_INT);
...
static char * test2() {
	...
	mv_t val = ps->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, ps->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_STRING);
	mu_assert_lf(val.u.strv != NULL);
	mu_assert_lf(streq(val.u.strv, "abc"));

	val = pdef->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pdef->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_STRING);
	mu_assert_lf(val.u.strv != NULL);
	mu_assert_lf(streq(val.u.strv, "def"));

	val = pdot->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pdot->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_STRING);
	mu_assert_lf(val.u.strv != NULL);
	mu_assert_lf(streq(val.u.strv, "abcdef"));

	val = ptolower->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, ptolower->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_STRING);
	mu_assert_lf(val.u.strv != NULL);
	mu_assert_lf(streq(val.u.strv, "abcdef"));

	val = ptoupper->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, ptoupper->pvstate);
	printf("[%s] %s\n", mt_describe_type(val.type), mv_alloc_format_val(&val));
	mu_assert_lf(val.type == MT_STRING);
	mu_assert_lf(val.u.strv != NULL);
	mu_assert_lf(streq(val.u.strv, "ABCDEF"));
...
static char * test3() {
	...
	mv_t valp2     = p2->pprocess_func(prec,     ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, p2->pvstate);
	mv_t valp4     = p4->pprocess_func(prec,     ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, p4->pvstate);
	mv_t valpx     = px->pprocess_func(prec,     ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, px->pvstate);
	mv_t valpx2    = px2->pprocess_func(prec,    ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, px2->pvstate);
	mv_t valplogx  = plogx->pprocess_func(prec,  ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, plogx->pvstate);
	mv_t valp2logx = p2logx->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, p2logx->pvstate);
	...
	printf("newval AST      = %s\n",
		mv_describe_val(pastr->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, pastr->pvstate)));
	printf("\n");

	lrec_rename(prec, "x", "y", FALSE);

	valp2     = p2->pprocess_func(prec,     ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, p2->pvstate);
	valp4     = p4->pprocess_func(prec,     ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, p4->pvstate);
	valpx     = px->pprocess_func(prec,     ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, px->pvstate);
	valpx2    = px2->pprocess_func(prec,    ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, px2->pvstate);
	valplogx  = plogx->pprocess_func(prec,  ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, plogx->pvstate);
	valp2logx = p2logx->pprocess_func(prec, ptyped_overlay, poosvars, poosvars_typed_overlay, pregex_captures, pctx, p2logx->pvstate);
