...
//  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
typedef struct _rxval_evaluator_from_map_literal_state__xxx_deprecated_t {
	map_literal_list_evaluator_t* proot_list_evaluator;
} rxval_evaluator_from_map_literal_state__xxx_deprecated_t;

static void rxval_evaluator_from_map_literal_aux_xxx_deprecated(
	rxval_evaluator_from_map_literal_state__xxx_deprecated_t* pstate,
	map_literal_list_evaluator_t*             plist_evaluator,
...
static void rxval_evaluator_from_map_literal_free(rxval_evaluator_xxx_deprecated_t* prxval_evaluator) {
	rxval_evaluator_from_map_literal_state__xxx_deprecated_t* pstate = prxval_evaluator->pvstate;
...
rxval_evaluator_xxx_deprecated_t* rxval_evaluator_alloc_from_map_literal_xxx_deprecated(mlr_dsl_ast_node_t* pnode, fmgr_t* pfmgr,
	int type_inferencing, int context_flags)
{
	rxval_evaluator_from_map_literal_state__xxx_deprecated_t* pstate = mlr_malloc_or_die(
		sizeof(rxval_evaluator_from_map_literal_state__xxx_deprecated_t));
