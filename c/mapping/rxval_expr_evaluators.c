...
////  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
//typedef struct _rxval_evaluator_from_map_literal_state__t {
//	map_literal_list_evaluator_t* proot_list_evaluator;
//} rxval_evaluator_from_map_literal_state__t;
//
//static void rxval_evaluator_from_map_literal_aux(
//	rxval_evaluator_from_map_literal_state__t* pstate,
//	map_literal_list_evaluator_t*             plist_evaluator,
...
//	rxval_evaluator_from_map_literal_state__t* pstate = pvstate;
//
...
//	rxval_evaluator_from_map_literal_state__t* pstate = prxval_evaluator->pvstate;
...
//	int type_inferencing, int context_flags)
//{
//	rxval_evaluator_from_map_literal_state__t* pstate = mlr_malloc_or_die(
//		sizeof(rxval_evaluator_from_map_literal_state__t));
...
static boxed_xval_t rxval_evaluator_from_full_srec_func(void* pvstate, variables_t* pvars) {
	...
	boxed_xval.map_is_ephemeral = TRUE;
