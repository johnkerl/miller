...
| a href="#>>" >> | arithmetic | 2 |
+--------------+-----------+-------+
| a href="#bitcount" bitcount | arithmetic | 1 |
+--------------+-----------+-------+
| a href="#==" == | boolean | 2 |
+--------------+-----------+-------+
| a href="#!=" != | boolean | 2 |
...
| a href="#." . | string | 2 |
+--------------+-----------+-------+
| a href="#gsub" gsub | string | 3 |
+--------------+-----------+-------+
| a href="#regextract" regextract | string | 2 |
+--------------+-----------+-------+
| a href="#regextract_or_else" regextract_or_else | string | 3 |
+--------------+-----------+-------+
| a href="#strlen" strlen | string | 1 |
+--------------+-----------+-------+
| a href="#sub" sub | string | 3 |
+--------------+-----------+-------+
| a href="#ssub" ssub | string | 3 |
+--------------+-----------+-------+
| a href="#substr" substr | string | 3 |
+--------------+-----------+-------+
| a href="#tolower" tolower | string | 1 |
+--------------+-----------+-------+
| a href="#toupper" toupper | string | 1 |
+--------------+-----------+-------+
| a href="#capitalize" capitalize | string | 1 |
+--------------+-----------+-------+
| a href="#lstrip" lstrip | string | 1 |
+--------------+-----------+-------+
| a href="#rstrip" rstrip | string | 1 |
+--------------+-----------+-------+
| a href="#strip" strip | string | 1 |
+--------------+-----------+-------+
| a href="#collapse_whitespace" collapse_whitespace | string | 1 |
+--------------+-----------+-------+
| a href="#clean_whitespace" clean_whitespace | string | 1 |
+--------------+-----------+-------+
| a href="#system" system | string | 1 |
+--------------+-----------+-------+
| a href="#abs" abs | math | 1 |
+--------------+-----------+-------+
| a href="#acos" acos | math | 1 |
+--------------+-----------+-------+
| a href="#acosh" acosh | math | 1 |
+--------------+-----------+-------+
| a href="#asin" asin | math | 1 |
+--------------+-----------+-------+
| a href="#asinh" asinh | math | 1 |
+--------------+-----------+-------+
| a href="#atan" atan | math | 1 |
+--------------+-----------+-------+
| a href="#atan2" atan2 | math | 2 |
+--------------+-----------+-------+
| a href="#atanh" atanh | math | 1 |
+--------------+-----------+-------+
| a href="#cbrt" cbrt | math | 1 |
+--------------+-----------+-------+
| a href="#ceil" ceil | math | 1 |
+--------------+-----------+-------+
| a href="#cos" cos | math | 1 |
+--------------+-----------+-------+
| a href="#cosh" cosh | math | 1 |
+--------------+-----------+-------+
| a href="#erf" erf | math | 1 |
+--------------+-----------+-------+
| a href="#erfc" erfc | math | 1 |
+--------------+-----------+-------+
| a href="#exp" exp | math | 1 |
+--------------+-----------+-------+
| a href="#expm1" expm1 | math | 1 |
+--------------+-----------+-------+
| a href="#floor" floor | math | 1 |
+--------------+-----------+-------+
| a href="#invqnorm" invqnorm | math | 1 |
+--------------+-----------+-------+
| a href="#log" log | math | 1 |
+--------------+-----------+-------+
| a href="#log10" log10 | math | 1 |
+--------------+-----------+-------+
| a href="#log1p" log1p | math | 1 |
+--------------+-----------+-------+
| a href="#logifit" logifit | math | 3 |
+--------------+-----------+-------+
| a href="#madd" madd | math | 3 |
+--------------+-----------+-------+
| a href="#max" max | math | variadic |
+--------------+-----------+-------+
| a href="#mexp" mexp | math | 3 |
+--------------+-----------+-------+
| a href="#min" min | math | variadic |
+--------------+-----------+-------+
| a href="#mmul" mmul | math | 3 |
+--------------+-----------+-------+
| a href="#msub" msub | math | 3 |
+--------------+-----------+-------+
| a href="#pow" pow | math | 2 |
+--------------+-----------+-------+
| a href="#qnorm" qnorm | math | 1 |
+--------------+-----------+-------+
| a href="#round" round | math | 1 |
+--------------+-----------+-------+
| a href="#roundm" roundm | math | 2 |
+--------------+-----------+-------+
| a href="#sgn" sgn | math | 1 |
+--------------+-----------+-------+
| a href="#sin" sin | math | 1 |
+--------------+-----------+-------+
| a href="#sinh" sinh | math | 1 |
+--------------+-----------+-------+
| a href="#sqrt" sqrt | math | 1 |
+--------------+-----------+-------+
| a href="#tan" tan | math | 1 |
+--------------+-----------+-------+
| a href="#tanh" tanh | math | 1 |
+--------------+-----------+-------+
| a href="#urand" urand | math | 0 |
+--------------+-----------+-------+
| a href="#urandrange" urandrange | math | 2 |
+--------------+-----------+-------+
| a href="#urand32" urand32 | math | 0 |
+--------------+-----------+-------+
| a href="#urandint" urandint | math | 2 |
+--------------+-----------+-------+
| a href="#dhms2fsec" dhms2fsec | time | 1 |
+--------------+-----------+-------+
| a href="#dhms2sec" dhms2sec | time | 1 |
+--------------+-----------+-------+
| a href="#fsec2dhms" fsec2dhms | time | 1 |
+--------------+-----------+-------+
| a href="#fsec2hms" fsec2hms | time | 1 |
+--------------+-----------+-------+
| a href="#gmt2sec" gmt2sec | time | 1 |
+--------------+-----------+-------+
| a href="#localtime2sec" localtime2sec | time | 1 |
+--------------+-----------+-------+
| a href="#hms2fsec" hms2fsec | time | 1 |
+--------------+-----------+-------+
| a href="#hms2sec" hms2sec | time | 1 |
+--------------+-----------+-------+
| a href="#sec2dhms" sec2dhms | time | 1 |
+--------------+-----------+-------+
| a href="#sec2gmt" sec2gmt | time | 1 |
+--------------+-----------+-------+
| a href="#sec2gmt" sec2gmt | time | 2 |
+--------------+-----------+-------+
| a href="#sec2gmtdate" sec2gmtdate | time | 1 |
+--------------+-----------+-------+
| a href="#sec2localtime" sec2localtime | time | 1 |
+--------------+-----------+-------+
| a href="#sec2localtime" sec2localtime | time | 2 |
+--------------+-----------+-------+
| a href="#sec2localdate" sec2localdate | time | 1 |
+--------------+-----------+-------+
| a href="#sec2hms" sec2hms | time | 1 |
+--------------+-----------+-------+
| a href="#strftime" strftime | time | 2 |
+--------------+-----------+-------+
| a href="#strftime_local" strftime_local | time | 2 |
+--------------+-----------+-------+
| a href="#strptime" strptime | time | 2 |
+--------------+-----------+-------+
| a href="#strptime_local" strptime_local | time | 2 |
+--------------+-----------+-------+
| a href="#systime" systime | time | 0 |
+--------------+-----------+-------+
| a href="#is_absent" is_absent | typing | 1 |
+--------------+-----------+-------+
| a href="#is_bool" is_bool | typing | 1 |
+--------------+-----------+-------+
| a href="#is_boolean" is_boolean | typing | 1 |
+--------------+-----------+-------+
| a href="#is_empty" is_empty | typing | 1 |
+--------------+-----------+-------+
| a href="#is_empty_map" is_empty_map | typing | 1 |
+--------------+-----------+-------+
| a href="#is_float" is_float | typing | 1 |
+--------------+-----------+-------+
| a href="#is_int" is_int | typing | 1 |
+--------------+-----------+-------+
| a href="#is_map" is_map | typing | 1 |
+--------------+-----------+-------+
| a href="#is_nonempty_map" is_nonempty_map | typing | 1 |
+--------------+-----------+-------+
| a href="#is_not_empty" is_not_empty | typing | 1 |
+--------------+-----------+-------+
| a href="#is_not_map" is_not_map | typing | 1 |
+--------------+-----------+-------+
| a href="#is_not_null" is_not_null | typing | 1 |
+--------------+-----------+-------+
| a href="#is_null" is_null | typing | 1 |
+--------------+-----------+-------+
| a href="#is_numeric" is_numeric | typing | 1 |
+--------------+-----------+-------+
| a href="#is_present" is_present | typing | 1 |
+--------------+-----------+-------+
| a href="#is_string" is_string | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_absent" asserting_absent | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_bool" asserting_bool | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_boolean" asserting_boolean | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_empty" asserting_empty | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_empty_map" asserting_empty_map | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_float" asserting_float | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_int" asserting_int | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_map" asserting_map | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_nonempty_map" asserting_nonempty_map | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_not_empty" asserting_not_empty | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_not_map" asserting_not_map | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_not_null" asserting_not_null | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_null" asserting_null | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_numeric" asserting_numeric | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_present" asserting_present | typing | 1 |
+--------------+-----------+-------+
| a href="#asserting_string" asserting_string | typing | 1 |
+--------------+-----------+-------+
| a href="#boolean" boolean | conversion | 1 |
+--------------+-----------+-------+
| a href="#float" float | conversion | 1 |
+--------------+-----------+-------+
| a href="#fmtnum" fmtnum | conversion | 2 |
+--------------+-----------+-------+
| a href="#hexfmt" hexfmt | conversion | 1 |
+--------------+-----------+-------+
| a href="#int" int | conversion | 1 |
+--------------+-----------+-------+
| a href="#string" string | conversion | 1 |
+--------------+-----------+-------+
| a href="#typeof" typeof | conversion | 1 |
+--------------+-----------+-------+
| a href="#depth" depth | maps | 1 |
+--------------+-----------+-------+
| a href="#haskey" haskey | maps | 2 |
+--------------+-----------+-------+
| a href="#joink" joink | maps | 2 |
+--------------+-----------+-------+
| a href="#joinkv" joinkv | maps | 3 |
+--------------+-----------+-------+
| a href="#joinv" joinv | maps | 2 |
+--------------+-----------+-------+
| a href="#leafcount" leafcount | maps | 1 |
+--------------+-----------+-------+
| a href="#length" length | maps | 1 |
+--------------+-----------+-------+
| a href="#mapdiff" mapdiff | maps | variadic |
+--------------+-----------+-------+
| a href="#mapexcept" mapexcept | maps | variadic |
+--------------+-----------+-------+
| a href="#mapselect" mapselect | maps | variadic |
+--------------+-----------+-------+
| a href="#mapsum" mapsum | maps | variadic |
+--------------+-----------+-------+
| a href="#splitkv" splitkv | maps | 3 |
+--------------+-----------+-------+
| a href="#splitkvx" splitkvx | maps | 3 |
+--------------+-----------+-------+
| a href="#splitnv" splitnv | maps | 2 |
+--------------+-----------+-------+
| a href="#splitnvx" splitnvx | maps | 2 |
+--------------+-----------+-------+
