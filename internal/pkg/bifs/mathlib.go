...
/*INT    */ {pow_f_ii, pow_f_if, _erro, _erro, _erro, _absn, _absn, _erro, _erro, _1___, _erro},
/*FLOAT  */ {pow_f_fi, pow_f_ff, _erro, _erro, _erro, _absn, _absn, _erro, _erro, _1___, _erro},
...
//       .  INT         FLOAT       BOOL   NULL   STRING ARRAY  MAP    FUNC    ERROR   ABSENT NULL
/*INT    */ {atan2_f_ii, atan2_f_if, _erro, _erro, _erro, _absn, _absn, _erro, _erro, _1___, _erro},
/*FLOAT  */ {atan2_f_fi, atan2_f_ff, _erro, _erro, _erro, _absn, _absn, _erro, _erro, _1___, _erro},
/*BOOL   */ {_erro,      _erro,      _erro, _erro, _erro, _absn, _absn, _erro, _erro, _erro, _erro},
/*VOID   */ {_void,      _void,      _erro, _erro, _erro, _absn, _absn, _erro, _erro, _absn, _erro},
/*STRING */ {_erro,      _erro,      _erro, _erro, _erro, _absn, _absn, _erro, _erro, _erro, _erro},
/*ARRAY  */ {_absn,      _absn,      _absn, _erro, _absn, _absn, _absn, _erro, _absn, _absn, _erro},
...
//       .  INT          FLOAT        BOOL   NULL   STRING ARRAY  MAP    FUNC    ERROR   ABSENT NULL
/*INT    */ {roundm_f_ii, roundm_f_if, _erro, _erro, _erro, _absn, _absn, _erro, _erro, _1___, _erro},
/*FLOAT  */ {roundm_f_fi, roundm_f_ff, _erro, _erro, _erro, _absn, _absn, _erro, _erro, _1___, _erro},
/*BOOL   */ {_erro,       _erro,       _erro, _erro, _erro, _absn, _absn, _erro, _erro, _erro, _erro},
/*VOID   */ {_void,       _void,       _erro, _erro, _erro, _absn, _absn, _erro, _erro, _absn, _erro},
/*STRING */ {_erro,       _erro,       _erro, _erro, _erro, _absn, _absn, _erro, _erro, _erro, _erro},
/*ARRAY  */ {_absn,       _absn,       _absn, _erro, _absn, _absn, _absn, _erro, _absn, _absn, _erro},
