...
// we sort primarly on field 1, then secondarily on field 2, etc., we need to be able to detect ties
// on field 1 so we can know whether to compare on field 2 or not.
